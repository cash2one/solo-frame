...
def get_report():
    ...
    """
    http = httplib2.Http()
    url = "https://api.hasoffers.com/Apiv3/json?NetworkId=wmadv&Target=Affiliate_Offer&Method=findMyApprovedOffers&api_key=aa5a425435d9c7147ebd5a98a91bf42d45264c985f67d2803f67957036489b19"
    headers = {
    ...
    offers_list_new = [] ##
    offers_list_old = OfferList.find_one(dict(_id=150)).offer_list if OfferList.find_one(dict(_id=150)) else [] ##
    for k, v in offers.iteritems():
        click_url = "https://api.hasoffers.com/Apiv3/json?NetworkId=wmadv&Target=Affiliate_Offer&Method=generateTrackingLink&api_key=aa5a425435d9c7147ebd5a98a91bf42d45264c985f67d2803f67957036489b19&offer_id=" + str(k)
        ...
        country_url = "https://api.hasoffers.com/Apiv3/json?NetworkId=wmadv&Target=Affiliate_Offer&Method=getTargetCountries&api_key=aa5a425435d9c7147ebd5a98a91bf42d45264c985f67d2803f67957036489b19&ids%5B%5D=" + str(k)
        ...
        try:
            ...
            continue
        platform_url = "https://api.hasoffers.com/Apiv3/json?NetworkId=wmadv&Target=Affiliate_OfferTargeting&Method=getRuleTargetingForOffer&api_key=aa5a425435d9c7147ebd5a98a91bf42d45264c985f67d2803f67957036489b19&offer_id=" + str(k)
        ...
        try:
            ...
            platform_url = ''
        icon_url = "https://api.hasoffers.com/Apiv3/json?NetworkId=wmadv&Target=Affiliate_OfferFile&Method=findAll&api_key=aa5a425435d9c7147ebd5a98a91bf42d45264c985f67d2803f67957036489b19&filters%5Boffer_id%5D=" + str(k)
        ...
        o = dict(
            ...
            platform=platform,
            click_url=click_url + "&source={affid}_{aff_sub2}&android_id={aff_sub1}&ios_ifa={aff_sub1}&aff_sub={clickid}",#
        ...
        if re:
            ...
            o.save()
    offers_list = OfferList.find_one(dict(_id=150)) ##
    if offers_list: ##
        offers_list._id = 150 ##
